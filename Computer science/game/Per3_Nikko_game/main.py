# This file was created by: Nikko Ruiz
...
class Game:
    ...
    def draw_text(self, surface, text, size, color, x, y):
        front_name = pg.font.match_font('arial')
        font = pg.font.Font(front_name, size)
    ...
    def draw(self):
        ...
        self.draw_text(self.screen, 'This game is awsome', 24, BLACK, WIDTH/2, HEIGHT/12)
        pg.display.flip()
